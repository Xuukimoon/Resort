...
BSS_CODE ALIGNED(4) char SoundMainRAM_Buffer[0xc10] = {0};//800
BSS_CODE ALIGNED(4) u32 hq_buffer_ptr[0x2c0] = {0};//2c0 maximo, E0 default
...
void m4aSoundInit(void)
{
    ...
    m4aSoundMode(SOUND_MODE_DA_BIT_8
               | SOUND_MODE_FREQ_26758//31536//40137//13379
...
void SoundInit(struct SoundInfo *soundInfo)
{
    ...
    SampleFreqSet(SOUND_MODE_FREQ_31536);//40137);//13379);
